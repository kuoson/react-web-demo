...
const rootReducer = combineReducers({
  user: userSlice,
  questionComponents: undoable(questionComponentsSlice, {
    limit: 20,
    filter: excludeAction([
      'questionComponents/resetComponents',
      'questionComponents/changeSelected',
      'questionComponents/selectPrevComponent',
      'questionComponents/selectNextComponent',
    ]),
  }),
...
const persistConfig = {
  ...
  blacklist: ['questionComponents'], // 不需要持久化保存的模块，默认不排除任何模块（语义：黑名单）
}
